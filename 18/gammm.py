...
print('FГ(t) =', ff,'+ С' )
C=5.46814401103062e-12*uppergamma(15.2760489269463, 0) #постоянная интегрирования
print('С =', C)
...
def func (x):
    return (-5.46814401103062e-12*uppergamma(15.2760489269463, 0.0670924301945216*x) + 1.00000000000005)
xlist = sample
