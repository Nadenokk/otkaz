...
T=175.96441799999997 #среднее время наработки до отказа
D=4659.022138964772 #дисперсия несмещённая
...
print('FГ(t) =', ff,'+ С' )
C=0.00266931017889726*uppergamma(6.64591742183881, 0) #постоянная интегрирования
print('С =', C)
...
def func (x):
    return (-0.00266931017889726*uppergamma(6.64591742183881, 0.0377685301231685*x) + 0.999999999999992)
xlist = sample
